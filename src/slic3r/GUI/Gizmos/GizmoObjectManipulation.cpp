...
void GizmoObjectManipulation::do_render_move_window(ImGuiWrapper *imgui_wrapper, std::string window_name, float x, float y, float bottom_limit)
{
    ...
    // add "Center" button
    const char* center_btn_title = _L("Center").ToUTF8().data();
    ...
    ImVec2 title_size = ImGui::CalcTextSize(center_btn_title);
    ...
    // draw button
    if (ImGui::Button(center_btn_title, ImVec2(btn_width, h))) {
